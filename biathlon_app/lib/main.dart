...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Biathlon Career'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _continueCareer() {
    setState(() {
      _career?.continueCareer();
    });
    _navigateToCareerDetails();
  }

  void _navigateToCareerDetails() {
    if (_career != null) {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => CareerDetailsScreen(career: _career!),
        ),
      );
    }
  }
